...
- Name: phase2-2-flows.spec.ts >> Phase 2.2 — workspace completion @critical >> DELETE accepts a body with transferToUserId and applies its role gate
- Location: e2e\phase2-2-flows.spec.ts:108:7
