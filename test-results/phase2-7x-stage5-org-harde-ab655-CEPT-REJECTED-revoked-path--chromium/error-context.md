...
- Name: phase2-7x-stage5-org-hardening.spec.ts >> Phase 2.7X Stage 5 — governance hardening @critical >> rejected accept attempts emit ORG_INVITE_ACCEPT_REJECTED (revoked path)
- Location: e2e\phase2-7x-stage5-org-hardening.spec.ts:264:7
