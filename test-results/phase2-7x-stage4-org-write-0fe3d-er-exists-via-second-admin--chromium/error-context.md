...
- Name: phase2-7x-stage4-org-write-surfaces.spec.ts >> Phase 2.7X Stage 4 — org write surfaces @critical >> last ORG_OWNER protection — cannot demote when only one owner exists (via second admin)
- Location: e2e\phase2-7x-stage4-org-write-surfaces.spec.ts:237:7
