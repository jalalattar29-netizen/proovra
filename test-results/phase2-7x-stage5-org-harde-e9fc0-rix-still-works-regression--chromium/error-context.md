...
- Name: phase2-7x-stage5-org-hardening.spec.ts >> Phase 2.7X Stage 5 — governance hardening @critical >> Phase 2.6D RBAC matrix still works (regression)
- Location: e2e\phase2-7x-stage5-org-hardening.spec.ts:386:7
