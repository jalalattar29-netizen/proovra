...
- Name: phase2-4-flows.spec.ts >> Phase 2.4 — backend completion @critical >> POST /v1/users/me/password/change refuses non-EMAIL providers (guest)
- Location: e2e\phase2-4-flows.spec.ts:118:7
