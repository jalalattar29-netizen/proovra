...
- Name: phase2-7x-stage4-org-write-surfaces.spec.ts >> Phase 2.7X Stage 4 — org write surfaces @critical >> last ORG_OWNER protections — cannot self-modify, cannot demote-self, cannot remove-self
- Location: e2e\phase2-7x-stage4-org-write-surfaces.spec.ts:207:7
