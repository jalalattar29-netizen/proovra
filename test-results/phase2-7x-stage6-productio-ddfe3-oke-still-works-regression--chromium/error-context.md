...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> Stage 5 invite revoke still works (regression)
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:210:7
