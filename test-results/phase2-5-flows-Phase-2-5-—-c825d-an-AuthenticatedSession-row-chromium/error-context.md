...
- Name: phase2-5-flows.spec.ts >> Phase 2.5 — operational scale @critical >> guest login records an AuthenticatedSession row
- Location: e2e\phase2-5-flows.spec.ts:41:7
