...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> invite create → accept round-trip works after token hashing
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:40:7
