...
- Name: phase2-7x-stage3-org-runtime.spec.ts >> Phase 2.7X Stage 3 — org runtime endpoints @critical >> Phase 2.6D RBAC matrix still returns canonical shape (regression)
- Location: e2e\phase2-7x-stage3-org-runtime.spec.ts:124:7
