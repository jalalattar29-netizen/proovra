...
- Name: phase2-7x-stage5-org-hardening.spec.ts >> Phase 2.7X Stage 5 — governance hardening @critical >> GET /v1/orgs/:id/invites lists pending invites for ORG_ADMIN+
- Location: e2e\phase2-7x-stage5-org-hardening.spec.ts:47:7
