...
- Name: phase2-7x-stage3-org-runtime.spec.ts >> Phase 2.7X Stage 3 — org runtime endpoints @critical >> GET /v1/orgs/:id validates the UUID parameter
- Location: e2e\phase2-7x-stage3-org-runtime.spec.ts:89:7
