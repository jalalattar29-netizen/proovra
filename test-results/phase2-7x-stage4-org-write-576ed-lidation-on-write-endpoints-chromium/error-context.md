...
- Name: phase2-7x-stage4-org-write-surfaces.spec.ts >> Phase 2.7X Stage 4 — org write surfaces @critical >> UUID validation on write endpoints
- Location: e2e\phase2-7x-stage4-org-write-surfaces.spec.ts:379:7
