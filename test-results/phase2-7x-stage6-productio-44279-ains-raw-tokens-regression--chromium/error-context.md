...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> audit metadata still never contains raw tokens (regression)
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:112:7
