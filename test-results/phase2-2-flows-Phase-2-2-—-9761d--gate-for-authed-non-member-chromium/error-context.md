...
- Name: phase2-2-flows.spec.ts >> Phase 2.2 — workspace completion @critical >> removal-impact endpoint enforces role gate for authed non-member
- Location: e2e\phase2-2-flows.spec.ts:86:7
