...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> invalid token returns 404 (hash lookup miss)
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:103:7
