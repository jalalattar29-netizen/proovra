...
- Name: phase2-7x-stage5-org-hardening.spec.ts >> Phase 2.7X Stage 5 — governance hardening @critical >> DELETE invite revokes + emits ORG_INVITE_REVOKED + blocks subsequent accept
- Location: e2e\phase2-7x-stage5-org-hardening.spec.ts:95:7
