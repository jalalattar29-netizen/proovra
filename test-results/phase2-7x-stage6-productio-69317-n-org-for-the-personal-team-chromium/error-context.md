...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> workspace-bootstrap atomically creates an org for the personal team
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:133:7
