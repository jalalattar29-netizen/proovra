...
- Name: phase2-5-flows.spec.ts >> Phase 2.5 — operational scale @critical >> Phase 2.4 password change still refuses guests (regression check)
- Location: e2e\phase2-5-flows.spec.ts:130:7
