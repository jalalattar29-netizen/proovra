...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> pending-invites listing never includes raw tokens
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:72:7
