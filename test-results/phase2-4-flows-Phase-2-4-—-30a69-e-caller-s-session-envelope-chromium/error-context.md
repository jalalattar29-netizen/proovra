...
- Name: phase2-4-flows.spec.ts >> Phase 2.4 — backend completion @critical >> GET /v1/users/me/sessions returns the caller's session envelope
- Location: e2e\phase2-4-flows.spec.ts:46:7
