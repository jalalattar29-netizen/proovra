...
- Name: phase2-6-teams-governance.spec.ts >> Phase 2.6 — teams governance @critical >> Phase 2.2 removal-impact endpoint contract intact
- Location: e2e\phase2-6-teams-governance.spec.ts:63:7
