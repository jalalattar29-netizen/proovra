...
- Name: phase2-6b-governance-aggregators.spec.ts >> Phase 2.6B — governance aggregators @critical >> Phase 2.6 permission matrix nav entry still present (regression guard)
- Location: e2e\phase2-6b-governance-aggregators.spec.ts:92:7
