...
- Name: phase2-7x-stage6-production-readiness.spec.ts >> Phase 2.7X Stage 6 — production readiness @critical >> explicit POST /v1/teams atomically creates an org for the new team
- Location: e2e\phase2-7x-stage6-production-readiness.spec.ts:154:7
