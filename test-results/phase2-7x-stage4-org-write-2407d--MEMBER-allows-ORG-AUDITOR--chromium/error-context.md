...
- Name: phase2-7x-stage4-org-write-surfaces.spec.ts >> Phase 2.7X Stage 4 — org write surfaces @critical >> audit list refuses ORG_MEMBER, allows ORG_AUDITOR+
- Location: e2e\phase2-7x-stage4-org-write-surfaces.spec.ts:342:7
