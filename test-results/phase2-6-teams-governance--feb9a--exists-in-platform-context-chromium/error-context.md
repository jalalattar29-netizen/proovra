...
- Name: phase2-6-teams-governance.spec.ts >> Phase 2.6 — teams governance @critical >> Phase 2.6 §10.5 — workspace.team_governance nav entry exists in platform context
- Location: e2e\phase2-6-teams-governance.spec.ts:80:7
