  ...
  return (
    <PageRouteGate routeId="workspace.trust_center">
      <TrustCenterSectionList
        ...
        anchor="security"
        relatedLinks={[
          { label: "Security & Responsible Disclosure", href: "/settings/legal/security" },
          { label: "Incident Response Policy", href: "/settings/legal/incident-response" },
          {
            label: "Technical & Organizational Measures",
            href: "/settings/legal/toms",
          },
        ]}
      />
    </PageRouteGate>
