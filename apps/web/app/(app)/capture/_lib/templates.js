export const COLLECTION_PLAN_TEMPLATES = [
    {
...
export const GENERIC_EVIDENCE_UPLOAD_ACCEPT = "image/*,video/*,audio/*,application/pdf,text/*,application/json,application/xml,text/xml,application/zip,application/x-zip-compressed,.csv,.log,.txt,.rtf,.doc,.docx,.xls,.xlsx,.eml,.msg,.zip,.json,.xml";
