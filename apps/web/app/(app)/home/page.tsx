...
export default function HomePage() {
  ...
  const bottomVelvetCardStyle = useMemo(
    () =>
      ({
        border: "1px solid rgba(191,232,223,0.16)",
        background:
          "linear-gradient(180deg, rgba(62,98,96,0.30) 0%, rgba(14,30,34,0.42) 100%)",
        boxShadow:
          "inset 0 1px 0 rgba(255,255,255,0.04), 0 14px 28px rgba(0,0,0,0.08)",
        ...
        <div className="flex flex-col gap-10 xl:flex-row xl:justify-between">
          <div className="w-full max-w-[720px] xl:pl-0">
            ...
            <div className="mt-6 flex flex-wrap gap-2.5">
              ...
              <div className="rounded-full border border-[rgba(191,232,223,0.16)] bg-[linear-gradient(180deg,rgba(195,235,226,0.05)_0%,rgba(255,255,255,0.02)_100%)] px-3.5 py-2 text-[0.78rem] font-normal text-[#cfe6e0] shadow-[0_8px_18px_rgba(0,0,0,0.08)] backdrop-blur-md">
                <span className="mr-2 text-[#c3ebe2]">✓</span>
          ...
          <div className="grid gap-5 xl:grid-cols-[1.08fr_0.92fr]">
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-7">
                ...
                <div className="mt-4 rounded-[22px] px-4 py-4" style={bottomVelvetCardStyle}>
                  <div className="mb-2 text-[0.78rem] font-semibold uppercase tracking-[0.18em] text-[#c9ddd7]">
                    Workspace flow
                  </div>
