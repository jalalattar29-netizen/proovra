...
export default function HomePage() {
  ...
  const primaryActionButtonStyle = useMemo(
    () =>
      ({
        borderColor: "rgba(191,232,223,0.20)",
        color: "#d6dfdc",
        backgroundImage:
          "linear-gradient(180deg, rgba(7,18,22,0.56) 0%, rgba(5,14,18,0.68) 100%), url('/images/site-velvet-bg.webp.png')",
        backgroundSize: "cover",
        backgroundPosition: "center",
        boxShadow:
          "0 14px 28px rgba(0,0,0,0.14), inset 0 1px 0 rgba(255,255,255,0.03)",
      }) as const,
    []
  );
        ...
        <div className="flex flex-col gap-10 xl:flex-row xl:justify-between">
          <div className="w-full max-w-[720px] xl:pl-0">
            ...
            <p className="mt-5 max-w-[640px] text-left text-[0.95rem] font-normal leading-[1.8] tracking-[-0.006em] text-[#aab5b2] md:text-[0.99rem]">
              Review your <span className="text-[#c7d0cd]">latest evidence</span>,
              continue active{" "}
              <span className="text-[#b9c4c1]">verification workflows</span>, and
              move quickly between <span className="text-[#ccd5d2]">capture</span>,{" "}
              <span className="text-[#ccd5d2]">reports</span>, and custody-ready
              records.
            </p>

            <div className="mt-6 flex flex-wrap gap-2.5">
              <div className="rounded-full border border-white/10 bg-white/[0.055] px-3.5 py-2 text-[0.78rem] font-normal text-[#c0cac7] shadow-[0_8px_18px_rgba(0,0,0,0.08)] backdrop-blur-md">
        ...
        <div className="mx-auto w-full max-w-[1180px]">
          <div className="grid gap-5 xl:grid-cols-[1.08fr_0.92fr]">
            <Card
              ...
              style={{
                border: "1px solid rgba(191,232,223,0.20)",
                boxShadow:
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-7">
                <div className="mb-5 flex items-start justify-between gap-4">
                  <div>
                    <div className="text-[1.08rem] font-semibold tracking-[-0.02em] text-[#c7d1ce]">
                      {t("recentEvidence")}
                    </div>
                  </div>

                  <div className="mt-1 inline-flex items-center rounded-full border border-[rgba(191,232,223,0.18)] bg-[rgba(255,255,255,0.028)] px-3 py-1.5 text-[0.7rem] font-medium uppercase tracking-[0.16em] text-[#c7d1ce]">
                    Active records
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  {loading ? (
                    ...
                    items.map((item) => {
                      const row = (
                        <div
                          className="rounded-[24px] border p-1 transition-all duration-200 hover:-translate-y-[1px] hover:shadow-[0_14px_26px_rgba(0,0,0,0.13)] [&_*]:!text-[#bfc8c5]"
                          style={{
                            borderColor: "rgba(191,232,223,0.16)",
                            backgroundImage:
                              "linear-gradient(180deg, rgba(7,18,22,0.60) 0%, rgba(5,14,18,0.74) 100%), url('/images/site-velvet-bg.webp.png')",
                            backgroundSize: "cover",
                            backgroundPosition: "center",
                          }}
                        >
                              ...
                              item.status === "SIGNED" ? (
                                ...
                                <span
                                  ...
                                  style={{
                                    color: "#c3ebe2",
                                    background:
                                      "linear-gradient(180deg, rgba(195,235,226,0.16) 0%, rgba(255,255,255,0.04) 100%)",
                                    border:
                                      "1px solid rgba(195,235,226,0.26)",
                                    boxShadow:
                                      "inset 0 1px 0 rgba(255,255,255,0.16), 0 4px 10px rgba(40,90,84,0.12)",
                                  }}
                                >
                                  Report Ready
                                </span>
              ...
              <div className="relative z-10 p-6 md:p-7">
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundPosition: "center",
                    boxShadow:
                      "0 14px 28px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.03)",
                  }}
                >
                  <div className="flex items-start gap-3">
                    <div
                      ...
                      style={{
                        ...
                        color: "#c3ebe2",
                        border: "1px solid rgba(191,232,223,0.20)",
                        boxShadow: "0 0 18px rgba(40,90,84,0.07)",
                      }}
                    >
                      ✓
                    </div>
                    ...
                    <div>
                      <div className="font-bold text-[#cfd7d4]">
                ...
                >
                  <div className="mb-2 text-[0.78rem] font-semibold uppercase tracking-[0.18em] text-[#c7d1ce]">
                    Workspace flow
                  </div>
