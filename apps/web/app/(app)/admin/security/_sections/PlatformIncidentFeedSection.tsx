...
/**
 * Platform Control Center P1 — Platform Security & Incidents feed.
 *
 * PHASE 12B: extracted verbatim in behaviour from the former monolithic
 * `admin/security/page.tsx` so that page can be the orchestrator for the
 * workspace-scoped Security Center sections alongside it. Unchanged
 * contract: READ-ONLY, platform-wide, no secrets / credentials / raw IPs.
 *
 ...
 *   - honest EmptyState / "Not measured" states when data is absent.
 *
...
import { DataTable, FilterBar, useToast } from "../../../../../components/ui";
...
export function PlatformIncidentFeedSection() {
  ...
  return (
    <>
      <PageSection
        ...
        description="Live severity breakdown across SecurityEvent + AdminAuditLog for the whole platform. Absent signals show “Not measured”, never estimated."
        action={
          <Button variant="secondary" onClick={() => void load()}>
            Refresh platform feed
          </Button>
        }
      >
        <div
...
export default PlatformIncidentFeedSection;
