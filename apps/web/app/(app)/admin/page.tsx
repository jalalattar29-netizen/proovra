...
export default function AdminPage() {
  ...
  const toolbarSegmentStyle = (active: boolean): CSSProperties => ({
    ...
    borderRadius: 999,
    cursor: "pointer",
    background: active ? UI.toolbarActiveBg : "transparent",
            ...
            <>
              ...
              <div style={{ marginBottom: 40 }}>
                ...
                <Card className="app-card" style={{ marginBottom: 16 }}>
                  <div style={subCardStyle()}>
                    ...
                    >
                      <div>
                        <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: 800, color: UI.textPrimary }}>
              ...
              <div style={{ marginBottom: 40 }}>
                ...
                >
                  <Card className="app-card">
                    <div style={subCardStyle()}>
                      <h3 style={{ margin: "0 0 20px 0", fontSize: 14, fontWeight: 800, color: UI.textPrimary }}>
                        Top Countries
                      </h3>
              ...
              <div style={{ marginBottom: 40 }}>
                ...
                <Card className="app-card">
                  <div style={subCardStyle()}>
                    <h3 style={{ margin: "0 0 20px 0", fontSize: 15, fontWeight: 800, color: UI.textPrimary }}>
                      Latest Events
                    </h3>
