...
export const ROUTE_REGISTRY = [
    ...
    // Settings IA remediation (2026-07-16) — dedicated child pages behind
    ...
    // users can jump straight there.
    {
        ...
        description: "Operational items that require your attention — reviews, mentions, invitations, governance, security, integrity, and delivery signals.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Platform roster of every customer organization (PLATFORM_ADMIN only): plan, seats, owner, domains, SSO/SCIM health, evidence/report volume, billing posture. Read-only aggregation.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Deep-dive on a single customer organization (PLATFORM_ADMIN only): identity health, provisioning history, evidence/billing posture. Read-only.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform roster of every user (PLATFORM_ADMIN only): org membership, roles, MFA enrolment, last login. Read-only aggregation. No secrets.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform evidence pipeline health (PLATFORM_ADMIN only): upload/processing status, signing/TSA/OTS failures, queue backlog, operational incidents. Read-only aggregation. No evidence content.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform security posture (PLATFORM_ADMIN only): security events, admin audit trail, operational incidents. Read-only aggregation. No raw IPs/tokens.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform billing posture (PLATFORM_ADMIN only): subscriptions by plan, payment/webhook status, storage add-on MRR, gross revenue. Read-only aggregation. No card/Stripe secrets.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform service & infrastructure health (PLATFORM_ADMIN only): DB/Redis/workers/queues/storage/KMS/SSO/providers status + a live Now panel. Read-only, connects existing health probes. Honest unknown where no live probe exists.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform provider-cost posture (PLATFORM_ADMIN only): estimated spend per provider/operation, budgets, embeddings spend. Read-only. Honest not-connected for unmetered categories. No secrets.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform feature usage & adoption (PLATFORM_ADMIN only): per-capability enabled/used/never-used derived from real entity counts. Read-only. No fabricated adoption score.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Cross-entity platform search (PLATFORM_ADMIN only): organizations, users, workspaces, leads, evidence/report IDs. Metadata only — no secrets, no evidence content.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform-wide event timeline (PLATFORM_ADMIN only): admin audit, org audit, security events, incidents, selected billing/team events. Read-only. Separate from evidence custody timelines.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        href: "/admin/alerts",
        label: "Alerts center",
        description: "Platform alerts center (PLATFORM_ADMIN only): open incidents, high security events, failed jobs, degraded services, billing/identity failures. Read-only point-in-time snapshot.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform executive KPIs (PLATFORM_ADMIN only): revenue, customers, leads, evidence/report/package volume, top & at-risk customers. Read-only. Growth/MRR/ARR honestly not-measured.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform-wide product analytics (PLATFORM_ADMIN only): traffic, events, geography — honest not-connected/not-measured states where a signal is absent.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        label: "Demo requests",
        description: "Inbound enterprise demo / contact-sales requests (PLATFORM_ADMIN only).",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Platform audit-log integrity console (PLATFORM_ADMIN only): tamper-evident chain verification over the admin/audit trail.",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        label: "Contact sales",
        description: "Operator view of a contact-sales / enterprise-interest submission (PLATFORM_ADMIN only).",
        domain: "PLATFORM_ADMIN",
        requiredCapabilities: ["PLATFORM_ADMIN"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    },
    {
        ...
        description: "Read-only governance view of external-reviewer grants: state, issuer, scope, expiration, watermark/download policy, and access audit.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Invite many members at once (paste or CSV) with validation, dry-run preview, and partial-success handling.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Operational report exports — members, seats, audit, governance, external access.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Organization operational readiness — status, SSO/integration health, evidence-operations signals.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Backup/DR, key management, resiliency posture and runbooks (verified config only).",
        domain: "OPS",
        requiredCapabilities: ["OBSERVABILITY_VIEW"],
        requiredActiveSpace: "PLATFORM_ADMIN",
        fallbackBehavior: "HIDDEN_IF_NO_CAPABILITY",
    ...
    // Phase 3 (Enterprise Identity) — Domains verification tab. Enterprise-gated
    // /v1/orgs/:orgId/domains backend; ENTERPRISE-tier via the /organizations
    // path prefix. Kept in sync with routeRegistry.ts.
    {
        id: "account.organization_admin_domains",
        href: "/organizations/:id/admin/domains",
        label: "Organization admin — Domains",
        description: "Verified email domains (DNS TXT). Gate SSO and auto-associate members to the organization.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    // into the admin shell tab bar. ENTERPRISE-tier via the /organizations
    // prefix; sidebarEligible: false. Kept in sync with routeRegistry.ts.
    {
        id: "account.organization_admin_roles",
        href: "/organizations/:id/admin/roles",
        label: "Organization admin — Roles & permissions",
        description: "Reference for the six built-in org roles and their org-scope capabilities. Assignment happens on the Members tab.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Enterprise plan + seat rollup across workspaces (read-only). Requires ORG_BILLING_ADMIN or higher.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
    ...
    },
    {
        ...
        description: "Per-workspace API keys + webhook endpoints, deep-linked to the canonical integrations portal.",
        domain: "ACCOUNT",
        requiredCapabilities: [],
        requiredActiveSpace: "NONE",
        fallbackBehavior: "LOAD",
