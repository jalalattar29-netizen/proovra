...
export const PILLAR_FOR_ROUTE_ID: ReadonlyMap<string, ProovraPillar> = new Map([
  ...
  ["security_center.identity", "GOVERNANCE"],
  ...
  ["security_center.identity_access_reviews", "ADMIN"],
  ["security_center.identity_permission_matrix", "ADMIN"],
  ["security_center.identity_runtime", "ADMIN"],
  ["security_center.identity_scim", "ADMIN"],
  ["security_center.identity_sessions", "ADMIN"],
  ["security_center.identity_timeline", "ADMIN"],
  ["platform.contact_sales_detail", "ADMIN"],
  ["platform.demo_request_detail", "ADMIN"],
