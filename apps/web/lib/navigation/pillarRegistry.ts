...
export const PILLAR_FOR_ROUTE_ID: ReadonlyMap<string, ProovraPillar> = new Map([
  ...
  ["admin.identity_access_reviews", "ADMIN"],
  ["admin.identity_permission_matrix", "ADMIN"],
  ["admin.identity_providers", "ADMIN"],
  ["admin.identity_runtime", "ADMIN"],
  ["admin.identity_scim", "ADMIN"],
  ["admin.identity_sessions", "ADMIN"],
  ["admin.identity_timeline", "ADMIN"],
