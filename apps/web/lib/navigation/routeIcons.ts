...
export const ROUTE_ICONS: Readonly<Record<string, RouteIcon>> = {
  ...
  "security_center.identity": Fingerprint,
  "security_center.identity_sessions": Fingerprint,
  "security_center.identity_scim": Users,
  "security_center.identity_access_reviews": ClipboardList,
  "security_center.identity_permission_matrix": Key,
  "security_center.identity_runtime": Activity,
  "security_center.identity_timeline": Clock,
  ...
  "operations.reliability": HeartPulse,
