...
const HINTS = {
    INDIVIDUAL: {
        dashboard: {
            ...
            body: "Pick a persona in workspace settings to adapt navigation, defaults, and labels to your workflow.",
        ...
        evidence: {
            ...
            body: "Use Capture to record media with hashed, signed integrity. Reports generate automatically once evidence is signed.",
    ...
    LAWYER: {
        dashboard: {
            ...
            body: "When matter activity grows, enable legal holds to preserve evidence and tag retention windows.",
        ...
        cases: {
            ...
            body: "Every matter carries a chain-of-custody timeline. Review it before generating verification packages.",
    ...
    INSURANCE: {
        dashboard: {
            ...
            body: "Configure claim routing so incoming submissions land with the right handler automatically.",
        ...
        "reviewer-ops": {
            ...
            body: "Set SLA windows on claim types so breaches surface immediately on the operational pressure tile.",
    ...
    INVESTIGATOR: {
        dashboard: {
            ...
            body: "Link related evidence across cases to surface cross-case intelligence in the dashboard.",
        ...
        cases: {
            ...
            body: "Use timeline reconstruction to sequence evidence across multiple capture sessions.",
    ...
    JOURNALIST: {
        dashboard: {
            ...
            body: "Once media is signed, a verification brief is generated that you can publish alongside the story.",
            ctaLabel: "Open evidence",
            ctaHref: "/evidence",
        },
        evidence: {
            ...
            body: "Each signed record carries a public verify URL — readers can confirm integrity without an account.",
    ...
    ENTERPRISE_COMPLIANCE: {
        dashboard: {
            ...
            body: "Set retention policies and audit-export schedules so compliance posture stays current without manual work.",
            ctaLabel: "Open governance",
            ctaHref: "/governance",
        ...
        governance: {
            ...
            body: "Configure retention windows and destruction reviews so legacy evidence is handled per policy.",
    ...
    ADMIN_OPERATOR: {
        dashboard: {
            ...
            body: "Queue pressure, incidents, and reviewer saturation update here every refresh cycle. Drill into operational pressure for details.",
        ...
        "reviewer-ops": {
            ...
            body: "Saturation scores surface reviewers nearing capacity so workload can be rebalanced before SLAs slip.",
