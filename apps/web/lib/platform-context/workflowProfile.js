...
const DESCRIPTORS = [
    {
        ...
        description: "Capture, verify, organize, and preserve digital records and evidence.",
    },
    {
        persona: "LAWYER",
        code: "LEGAL_CASEWORK",
        label: "Legal & Case Workflows",
        description: "Manage evidence, timelines, reports, and review workflows for legal or case-based operations.",
    },
    {
        persona: "INSURANCE",
        code: "REVIEW_OPERATIONS",
        label: "Review & Operations",
        description: "Handle high-volume intake, review queues, assignments, routing, and operational workflows.",
    },
    {
        persona: "INVESTIGATOR",
        code: "INVESTIGATION_RECONSTRUCTION",
        label: "Investigation & Reconstruction",
        description: "Analyze timelines, relationships, incidents, and evidence connections across workflows.",
    },
    {
        persona: "JOURNALIST",
        code: "MEDIA_VERIFICATION",
        label: "Media & Publication Verification",
        description: "Verify media, prepare publication-ready records, and manage authenticity workflows.",
    },
    {
        persona: "ENTERPRISE_COMPLIANCE",
        code: "GOVERNANCE_COMPLIANCE",
        label: "Governance & Compliance",
        description: "Manage retention, audit readiness, governance posture, and operational controls.",
    },
    {
        persona: "ADMIN_OPERATOR",
        code: "OPERATIONAL_ADMINISTRATION",
        label: "Operational Administration",
        description: "Monitor operational health, queues, incidents, escalations, and platform workflows.",
    },
];
const BY_PERSONA = new Map(DESCRIPTORS.map((d) => [d.persona, d]));
const BY_CODE = new Map(DESCRIPTORS.map((d) => [d.code, d]));
/**
