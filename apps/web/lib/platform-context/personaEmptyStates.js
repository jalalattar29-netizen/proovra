...
const DEFAULTS = {
    cases: {
        title: "No cases yet",
        body: "Create your first case and attach verified evidence to track progress.",
        primaryCtaLabel: "Create a case",
        primaryCtaHref: "/cases?action=create",
    },
    reports: {
        title: "No reports yet",
        body: "Reports are generated from signed evidence. Capture or upload evidence to make a report available.",
        primaryCtaLabel: "Open evidence",
        primaryCtaHref: "/evidence",
    },
    evidence: {
        title: "No evidence yet",
        body: "Capture or upload media to generate a hashed, signed evidence record.",
...
const OVERRIDES = {
    INDIVIDUAL: {
        cases: {
            ...
            body: "Group related evidence into a case so reports and verification can reference them together.",
            primaryCtaLabel: "Create a case",
            primaryCtaHref: "/cases?action=create",
        },
        home: {
            title: "Capture, verify, report",
            body: "Use Capture to record media with hashed, signed integrity. Reports are generated automatically once evidence is signed.",
            primaryCtaLabel: "Start capture",
            primaryCtaHref: "/capture",
        },
    },
    LAWYER: {
        cases: {
            ...
            body: "Attach verified evidence and chain-of-custody timelines to track the matter end-to-end.",
            primaryCtaLabel: "Create a matter",
            primaryCtaHref: "/cases?action=create",
        },
        reports: {
            title: "No evidence reports yet",
            body: "Evidence reports surface here once captured material is signed and a report is generated.",
            primaryCtaLabel: "Open evidence library",
            primaryCtaHref: "/evidence",
        },
        governance: {
            title: "Legal hold + retention controls",
            body: "Manage legal holds, retention, and destruction reviews from the organization workspace.",
    ...
    INSURANCE: {
        cases: {
            title: "Start a claim",
            body: "Open a claim, route to the right handler, and track SLA pressure from the queue.",
            primaryCtaLabel: "Open claims queue",
            primaryCtaHref: "/cases",
        },
        "reviewer-ops": {
            title: "Claims queue is empty",
            body: "Routed claims, handler assignments, and SLA breaches will appear here as work arrives.",
    ...
    INVESTIGATOR: {
        cases: {
            ...
            body: "Investigations group materials, timelines, and relationships across multiple cases.",
            primaryCtaLabel: "Create an investigation",
            primaryCtaHref: "/cases?action=create",
        },
        evidence: {
            title: "Capture or import materials",
            body: "Investigations operate over materials with chain-of-custody and location context preserved.",
            primaryCtaLabel: "Start capture",
            primaryCtaHref: "/capture",
        },
    },
    JOURNALIST: {
        evidence: {
            ...
            body: "Capture or upload media to generate a hash + signature you can publish alongside the story.",
            primaryCtaLabel: "Start capture",
            primaryCtaHref: "/capture",
        },
        reports: {
            title: "No verification briefs yet",
            body: "Generate a verification brief from a signed media record to share with editors or readers.",
            primaryCtaLabel: "Open evidence",
            primaryCtaHref: "/evidence",
        },
    },
    ENTERPRISE_COMPLIANCE: {
        governance: {
            ...
            body: "Set retention, legal-hold, and destruction policies once an organization workspace is active.",
            primaryCtaLabel: "Open governance",
            primaryCtaHref: "/governance",
        },
        cases: {
            title: "No review matters yet",
            body: "Open a review matter to bundle audit-relevant evidence with policy attestations.",
    ...
    ADMIN_OPERATOR: {
        ops: {
            ...
            body: "Queue pressure, incidents, and reviewer saturation will appear here when operational signal arrives.",
