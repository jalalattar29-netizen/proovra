...
import { useMainLandmarkOwned } from "../navigation/MainLandmarkContext";
...
export function ProovraSystemState({
  ...
  const mainOwned = useMainLandmarkOwned();
  ...
  return (
    // Standalone full-page states supply a landmark; in-shell states inherit it.
    <div
      style={wrap}
      role={isFull && !mainOwned ? "main" : undefined}
