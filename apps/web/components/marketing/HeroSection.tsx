...
/* The 3D canvas (and its PNG fallback) fill the tower footprint exactly. */
.proovra-hero-tower canvas,
.proovra-hero-tower > div {
  width: 100% !important;
  height: 100% !important;
  display: block;
}
.proovra-hero-tower > img {
  width: 100%;
  height: 100%;
  object-fit: contain;
}
...
Digital evidence infrastructure for legal, insurance, investigation, compliance, and public-sector teams that require trusted records, verification, and audit-ready reporting.
      ...
      <HeroTower3D className="proovra-hero-tower" />
    </section>
  );
}
