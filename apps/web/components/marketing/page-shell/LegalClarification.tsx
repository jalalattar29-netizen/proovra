...
export type LegalClarificationProps = {
  body?: string;
};
...
export function LegalClarification({ body = DEFAULT_BODY }: LegalClarificationProps) {
  return (
    <section className="relative bg-white">
      <div className="mx-auto max-w-[1480px] px-5 md:px-7 pb-12 lg:px-10 2xl:px-12 lg:pb-16">
        <div className="rounded-[20px] border border-[#E5E7EB] bg-[#F8FAFC] p-6">
