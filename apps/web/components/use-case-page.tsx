                ...
                <div className="max-w-[900px]">
                  ...
                  <div className="mt-8 rounded-[22px] border border-[rgba(79,112,107,0.18)] bg-[rgba(255,255,255,0.34)] p-5 shadow-[0_12px_28px_rgba(0,0,0,0.05)]">
                    ...
                    <p className="mt-3 text-[0.96rem] leading-[1.85] text-[#55666a]">
                      PROOVRA verifies the recorded integrity state, timestamp-related
                      context, custody metadata, and supporting review materials for an
                      evidence record. It does not by itself establish truth, authorship,
                      identity, or legal admissibility in a specific jurisdiction.
                    </p>
                  </div>
                </div>
              </div>
