    ...
    <div className="relative">
      ...
      <div className="relative h-[620px] w-[318px] rounded-[3.2rem] border border-[#56626a] bg-[linear-gradient(180deg,#26323a_0%,#141b22_100%)] p-[10px] shadow-[0_30px_70px_rgba(0,0,0,0.45)]">
        ...
        <div className="relative h-full w-full overflow-hidden rounded-[2.7rem] border border-[rgba(183,157,132,0.22)] bg-[#071116]">
          ...
          <div className="relative flex items-center justify-between px-6 pb-2 pt-3 text-[11px] text-[#d9cdbf]">
            <span className="font-medium tracking-wide">09:41</span>
            <div className="h-7 w-24 rounded-full bg-black/85" />
            <div className="flex items-center gap-1.5">
              <div className="h-2 w-4 rounded-sm bg-[#d9cdbf]/78" />
              <div className="h-2 w-2 rounded-full bg-[#d9cdbf]/78" />
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-between px-5 py-3">
            <div className="flex items-center gap-2.5">
              <div className="relative flex h-7 w-7 items-center justify-center overflow-hidden rounded-md border border-[rgba(183,157,132,0.34)] bg-[#123338] shadow-[0_8px_18px_rgba(67,140,145,0.18)]">
                ...
                <Shield className="relative z-10 h-4 w-4 text-[#f0ece6]" />
              </div>

              <span className="text-[1.05rem] font-semibold tracking-tight text-[#e3d7ca]">
                PROOVRA
              </span>
            </div>
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-full border border-[rgba(183,157,132,0.34)] bg-[rgba(255,255,255,0.04)] backdrop-blur-sm">
              <Bell className="h-4 w-4 text-[#d8cbbb]" />
            </div>
          </div>
          ...
          <div className="relative mx-4 mt-3 overflow-hidden rounded-[1.8rem] border border-[rgba(183,157,132,0.36)] bg-[#08151a] px-4 py-4 shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-md">
            ...
            <div className="relative z-10 mb-3 flex items-start justify-between">
              <div>
                <h3 className="text-[1.05rem] font-semibold tracking-tight text-[#f0e5d8]">
                  Case #4589
                </h3>
                <p className="mt-1 text-[0.82rem] text-[#cbbcad]">
                  Evidence Upload
                </p>
              </div>

              <ChevronRight className="mt-0.5 h-5 w-5 text-[#cdbdaa]/82" />
            </div>
            ...
            <div className="relative mb-5 mt-4 overflow-hidden rounded-[1.35rem] border border-[rgba(183,157,132,0.22)] shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
              ...
              <div className="relative z-10 px-4 py-7">
                <div className="flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full border-[3px] border-[rgba(183,157,132,0.94)] bg-white/[0.02]">
                    <Check className="h-8 w-8 text-[#efe3d4]" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 space-y-3">
              <p className="text-[0.86rem] font-medium text-[#efe4d8]">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="relative flex h-5 w-5 items-center justify-center overflow-hidden rounded-full bg-[#355f62]">
                    ...
                    <Check className="relative z-10 h-3.5 w-3.5 text-[#f2ece4]" />
                  </div>
                  <span className="text-[0.9rem] text-[#ddd1c4]">Uploaded</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[0.9rem] text-[#ddd1c4]">Processing</span>
                  <div className="ml-2 h-[4px] flex-1 rounded-full bg-[rgba(183,157,132,0.14)]">
                    <div className="h-[4px] w-[68%] rounded-full bg-[rgba(183,157,132,0.36)]" />
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <div className="h-5 w-5 rounded-full border border-[rgba(183,157,132,0.72)] bg-white/[0.02]" />
                  <span className="text-[0.9rem] text-[#bfae9c]">Verified</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 border-t border-[rgba(183,157,132,0.28)] bg-[#071319] px-4 pb-7 pt-4 backdrop-blur-md">
            ...
            <div className="relative z-10 grid grid-cols-4 gap-3">
              <div className="flex flex-col items-center gap-1.5">
                <Shield className="h-5 w-5 text-[#dbcdbd]" />
                <span className="text-[10px] font-medium text-[#d4c6b6]">Cases</span>
              </div>

              <div className="flex flex-col items-center gap-1.5">
                <Upload className="h-5 w-5 text-[#dbcdbd]" />
                <span className="text-[10px] font-medium text-[#d4c6b6]">Upload</span>
              </div>

              <div className="flex flex-col items-center gap-1.5">
                <Scan className="h-5 w-5 text-[#dbcdbd]" />
                <span className="text-[10px] font-medium text-[#d4c6b6]">Scan</span>
              </div>

              <div className="flex flex-col items-center gap-1.5">
                <Settings className="h-5 w-5 text-[#dbcdbd]" />
                <span className="text-[10px] font-medium text-[#d4c6b6]">Settings</span>
              </div>
            </div>

            <div className="relative z-10 mt-4 flex justify-center">
              <div className="h-1.5 w-28 rounded-full bg-[rgba(183,157,132,0.82)]" />
            </div>
          </div>
        </div>
      </div>
