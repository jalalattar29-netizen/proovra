...
import { GoogleBrandIcon, PROVIDER_BUTTON_COLORS } from "./provider-brand";
      ...
      */}
      ...
      <View style={styles.buttonInner}>
        {loading ? (
          ...
          <FontAwesome name="apple" size={21} color={PROVIDER_BUTTON_COLORS.apple.icon} />
        ) : (
          left
        )}
...
function buttonPalette(variant: ButtonVariant): { bg: string; fg: string; border: string } {
  switch (variant) {
    ...
    case "google":
      return PROVIDER_BUTTON_COLORS.google;
    case "apple":
      return PROVIDER_BUTTON_COLORS.apple;
    case "secondary":
    default:
