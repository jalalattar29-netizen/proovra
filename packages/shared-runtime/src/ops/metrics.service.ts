...
export const COUNTER_NAMES = [
  ...
  // Phase P1.1 — identity operations completion.
  ...
  // Phase P3.1 — Signer governance + custody attestations.
  ...
  // Phase O1.2 — observability coverage closure additions.
  "queue_retry_total",
  ...
  // Phase P2.0 — AWS Secrets Manager hydration / fallback.
