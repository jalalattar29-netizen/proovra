...
export async function buildReportPdf(params: {
  ...
  doc.info = {
    ...
    Subject:
      "PROOVRA_SECTION_ORDER: Evidence Summary > Cryptographic Details > Chain of Custody > Appendix A > Appendix B > Report Footer",
  ...
  doc.fontSize(18).text("Proovra — Verifiable Evidence Report", {
    align: "center",
  });
  doc.moveDown(0.5);
  doc.fontSize(10);
  ...
  addKeyValue(
    doc,
    "Timestamp Source",
    "All timestamps are generated by a server-synchronized UTC clock."
  );
  addKeyValue(doc, "System", "Proovra");
  if (params.buildInfo) {
