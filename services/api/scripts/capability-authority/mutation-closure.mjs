...
const FAMILY_RULES = Object.freeze([
  ...
  [/^(user|authenticatedSession|revokedSession|mfa|stepUpChallenge|trustedDevice|verificationAttempt|emailVerificationToken|passwordReset|extensionAuthCode|accountClosureRequest|accountDataExportRequest|identityLink|communication|notification|analyticsEvent|analyticsSession|cookieConsentRecord|workspaceNotificationPreference|notificationSchedule|workspaceAiPolicy|geoIntelligenceLookup)/i, "ACCOUNT_SESSION_SECURITY"],
  // ---------------------------------------------------------------------
