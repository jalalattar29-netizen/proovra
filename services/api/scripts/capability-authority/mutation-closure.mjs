...
const FAMILY_RULES = Object.freeze([
  ...
  [/^(apiCredential|apiKey|adminAuditLog|securityEvent|securityClaimCheck|emergencyAccessGrant|supportAccessGrant|operationalIncident|operationalCorrelation|accessAnomaly|riskSignal|governancePolicy|governanceNotification|trustCenter|subprocessor|status|maintenanceWindow|accessReview|signingKey|intelligenceActivityEvent|operationsInboxSnapshot|inboxItemState)/i, "API_KEY_SECRET_OPERATIONAL_ADMIN"],
