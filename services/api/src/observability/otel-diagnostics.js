...
function resolveVersion(packageName) {
    try {
        const manifest = require_(`${packageName}/package.json`);
...
export function getOtelRuntimeDiagnostics() {
    ...
    const serviceName = (process.env.OTEL_SERVICE_NAME ?? "").trim() || null;
    return {
        otelEnabled,
        serviceName,
        ...
        packageVersions: {
            ...
            "@opentelemetry/exporter-trace-otlp-proto": resolveVersion("@opentelemetry/exporter-trace-otlp-proto"),
            "@opentelemetry/resources": resolveVersion("@opentelemetry/resources"),
            "@opentelemetry/auto-instrumentations-node": resolveVersion("@opentelemetry/auto-instrumentations-node"),
            "@opentelemetry/semantic-conventions": resolveVersion("@opentelemetry/semantic-conventions"),
        },
        sentry: {
