...
export function initSentry() {
    ...
    // product of the two.
    const tracesSampleRate = readSampleRate("SENTRY_TRACES_SAMPLE_RATE", 0.2);
    const profilesSampleRate = readSampleRate("SENTRY_PROFILES_SAMPLE_RATE", 0.1);
