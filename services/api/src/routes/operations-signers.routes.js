...
import { getSignerById, listAllSigners, SIGNER_PROVIDERS, SIGNER_PURPOSES, } from "../services/operations/signer-registry.service.js";
import { probeSignerHealth } from "../services/operations/signer-health.service.js";
import { listSignerAudit, previewRotation, promoteStagedSigner, retireSigner, revokeSigner, stageSigner, } from "../services/operations/signer-rotation.service.js";
import { backfillCustodyAttestations, listAttestations, signCustodyEvent, verifyCustodyAttestation, } from "../services/operations/custody-attestation.service.js";
...
export async function operationsSignersRoutes(app) {
    // -------------------------------------------------------------------
    // Listing
    // -------------------------------------------------------------------
    app.get("/v1/operations/signers", { preHandler: requireAuth }, async (req, reply) => {
        const q = z
    ...
    app.get("/v1/operations/signers/:id", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
    ...
    // Health + audit
    // -------------------------------------------------------------------
    app.get("/v1/operations/signers/:id/health", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const q = z
    ...
    app.get("/v1/operations/signers/:id/audit", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const q = z
    ...
    // Rotation lifecycle
    // -------------------------------------------------------------------
    app.post("/v1/operations/signers/stage", { preHandler: requireAuth }, async (req, reply) => {
        const body = z
            .object({
            teamId: z.string().uuid(),
    ...
    app.post("/v1/operations/signers/:id/preview", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const body = z
    ...
    app.post("/v1/operations/signers/:id/promote", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const body = z
    ...
    app.post("/v1/operations/signers/:id/retire", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const body = z
    ...
    app.post("/v1/operations/signers/:id/revoke", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const body = z
    ...
    // -------------------------------------------------------------------
    app.get("/v1/operations/custody-attestations", { preHandler: requireAuth }, async (req, reply) => {
        const q = z
            .object({
            teamId: z.string().uuid(),
    ...
    app.post("/v1/operations/custody-attestations/backfill", { preHandler: requireAuth }, async (req, reply) => {
        const body = z
            .object({
            teamId: z.string().uuid(),
    ...
    app.post("/v1/operations/custody-attestations/:id/verify", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ id: z.string().min(1).max(200) })
            .parse(req.params);
        const body = z
    ...
    app.post("/v1/evidence/:evidenceId/custody/attestations/sign", { preHandler: requireAuth }, async (req, reply) => {
    ...
    app.get("/v1/evidence/:evidenceId/custody/attestations", { preHandler: requireAuth }, async (req, reply) => {
        const params = z
            .object({ evidenceId: z.string().uuid() })
            .parse(req.params);
        const q = z
