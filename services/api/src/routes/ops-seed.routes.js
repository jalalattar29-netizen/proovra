...
import { OperationalSeedError, SEED_SCENARIOS, assertSeedingSecret, cleanupSeedRun, listSeedRuns, runOperationalSeed, } from "../services/ops/operational-seed.service.js";
...
async function requireSeedActor(req, reply, teamId) {
...
function getSeedSecretHeader(req) {
...
function mapSeedErrorToResponse(reply, err) {
...
export async function opsSeedRoutes(app) {
    // ---------------------------------------------------------------------------
    // POST /v1/ops/seed/reviewer-ops — run a seed scenario.
    // ---------------------------------------------------------------------------
    app.post("/v1/ops/seed/reviewer-ops", { preHandler: requireAuth }, async (req, reply) => {
    ...
    // ---------------------------------------------------------------------------
    app.get("/v1/ops/seed/reviewer-ops", { preHandler: requireAuth }, async (req, reply) => {
    ...
    // DELETE /v1/ops/seed/reviewer-ops/:seedRunId — cleanup a seed run.
    // ---------------------------------------------------------------------------
    app.delete("/v1/ops/seed/reviewer-ops/:seedRunId", { preHandler: requireAuth }, async (req, reply) => {
