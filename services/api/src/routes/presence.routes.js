...
import { listViewersAsyncViaSelector as listViewers, recordHeartbeatViaSelector as recordHeartbeat, } from "../services/presence/presence-selector.js";
...
export async function presenceRoutes(app) {
    ...
    // ---------------------------------------------------------------------
    app.post("/v1/me/presence/heartbeat", { preHandler: requireAuth }, async (req, reply) => {
    ...
    // ---------------------------------------------------------------------
    app.get("/v1/me/presence/here", { preHandler: requireAuth }, async (req, reply) => {
        const userId = getAuthUserId(req);
