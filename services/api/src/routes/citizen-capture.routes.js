...
import { z } from "zod";
import { CAPTURE_MODES, CAPTURE_PROVENANCE_CLASSES, CAPTURE_SIGNATURE_ALGORITHMS, } from "@proovra/shared";
import { prisma } from "../db.js";
import { acceptCitizenCapture, buildCitizenSessionDescriptor, } from "../services/capture-trust/citizen-capture.service.js";
...
export async function citizenCaptureRoutes(app) {
    // ---------------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------------
    app.post("/v1/intake/citizen/sessions", async (req, reply) => {
    ...
    // ---------------------------------------------------------------------------
    app.post("/v1/intake/citizen/sessions/:id/capture", async (req, reply) => {
