...
async function fallbackAdminCheck(req, reply) {
...
async function checkCronSecret(req, reply, envName, headerName) {
...
export function requireNotificationCronSecret(req, reply) {
    return checkCronSecret(req, reply, NOTIFICATION_SECRET_ENV, NOTIFICATION_CRON_HEADER);
}
export function requireIntegrationCronSecret(req, reply) {
    return checkCronSecret(req, reply, INTEGRATION_SECRET_ENV, INTEGRATION_CRON_HEADER);
}
