...
function boundedFailure(jobId, reason) {
 ...
 * indexer step.
 */
export async function enqueueGraphReconcileJob(payload) {
    ...
    try {
        ...
        await queue.add(graphReconcileJobName, {
        ...
        const bounded = err instanceof Error ? err.message.slice(0, 120) : "unknown";
