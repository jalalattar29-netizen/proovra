...
function resolveExistingFilePath(rawPath) {
...
export function loadPemFromPathEnv(envName) {
...
export function ed25519SignHexWithKeyPath(messageHex, privateKeyPathEnv) {
