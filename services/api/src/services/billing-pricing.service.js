...
import { PLAN_CAPABILITIES, formatBytesHuman, } from "@proovra/shared-billing";
...
export function getPlanPriceCents(plan, currency) {
...
export function getStripePlanPriceId(plan, currency) {
    if (plan === prismaPkg.PlanType.PAYG) {
        return currency === "EUR"
...
export function getStorageAddonPriceCents(params) {
    ...
    const fallback = listStorageAddonDefinitions().find((item) => item.key === params.addonKey)
        ?.priceCents ?? 0;
...
export function buildPricingCatalogResponse(params) {
    ...
    return {
        ...
        free: {
            ...
            verificationPackageIncluded: PLAN_CAPABILITIES.FREE.verificationPackageIncluded,
        ...
        payg: {
            ...
            verificationPackageIncluded: PLAN_CAPABILITIES.PAYG.verificationPackageIncluded,
            publicVerifyIncluded: PLAN_CAPABILITIES.PAYG.publicVerifyIncluded,
            creditsRequiredPerCompletion: PLAN_CAPABILITIES.PAYG.paygCreditsRequiredPerCompletion,
        ...
        pro: {
            ...
            verificationPackageIncluded: PLAN_CAPABILITIES.PRO.verificationPackageIncluded,
        ...
        team: {
            ...
            verificationPackageIncluded: PLAN_CAPABILITIES.TEAM.verificationPackageIncluded,
