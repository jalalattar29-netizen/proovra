...
const SEED_ARTICLES = [
    ...
    },
    {
        ...
        summary: "Key management is deferred: a canonical signer registry tracks signing key identifiers (report PDF, verification package, export manifest, custody event) as a read-model over env config + SecurityEvent history. AWS KMS is supported when SIGNER_PROVIDER=aws_kms; otherwise local PEM or disabled.",
    ...
    },
    {
        ...
        slug: "retention",
        title: "Retention",
        summary: "Retention policies are governed by the Governance Policy registry (kind=RETENTION) with org / department / workspace scope + inheritance + override. Phase 4B legal hold + retention reconciliation worker enforce the configured windows.",
