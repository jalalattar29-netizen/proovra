 ...
 */
export function signMfaPendingToken(payload, secret, jti) {
    if (jti) {
    ...
    return signJwt({ ...payload, mfa: "pending" }, secret, MFA_PENDING_TTL_SECONDS);
}
/**
 ...
 * verify endpoint.
 */
export function verifyMfaPendingTokenSignature(token, secret) {
