 ...
 */
import { DELEGATED_ADMIN_GRANT_STATES, DELEGATED_ADMIN_TIERS, } from "@proovra/shared";
import { prisma as defaultPrisma } from "../../db.js";
import { emitDelegatedAdminEvent } from "../trust/trust-and-governance-audit.service.js";
export async function grantDelegatedAdmin(input) {
    if (!DELEGATED_ADMIN_TIERS.includes(input.tier)) {
...
function expandAcceptableTiers(requiredTier) {
