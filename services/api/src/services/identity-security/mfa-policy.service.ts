...
//
// The former `updateMfaPolicy` was an UNVERSIONED upsert: two operators editing
// the posture concurrently produced a silent last-writer-wins overwrite. It
// was removed with its retired route (2026-09-17). This is the one MFA policy
// writer, used by the admin Security Center editor: the version the
