...
import { getEmailFromHeader, sendCustomEmailViaResend, renderEmailShell, escapeEmailHtml, getEmailBrandName, } from "../email.service.js";
import { enqueueOutboundMessage } from "../communications/communication.service.js";
import { recordInviteDeliveryResult, } from "./collaboration-team.service.js";
/**
 ...
 */
export async function sendCollaborationTeamInviteEmail(ctx) {
    if (!ctx.email)
        return false;
    ...
    `,
        ...
        secondaryText: "Proovra — secure custody and verification of digital evidence.",
    });
    const text = [
 ...
 */
export async function sendCollaborationTeamInviteSms(ctx) {
    if (!ctx.phone)
        return false;
