...
export const CAPTURE_DRAFT_EXPIRY_MS =
  CAPTURE_DRAFT_EXPIRY_DAYS * 24 * 60 * 60 * 1000;
 ...
 */
export function buildDefaultCaptureDraftExpiry(now = Date.now()): Date {
 ...
 */
export function sanitizeCaptureSessionItem<
