 ...
 */
import { TRUST_DECAY_DEFAULT_MAX, TRUST_DECAY_STALE_DAYS, computeTrustDecay, } from "@proovra/shared";
import { prisma as defaultPrisma } from "../../db.js";
import { bump, setGauge } from "../ops/metrics.service.js";
import { safeEmitSecurityEvent } from "../security/security-event.service.js";
export async function sweepTrustedDeviceDecay(input, client = defaultPrisma) {
