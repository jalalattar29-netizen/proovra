...
const VERDICT_FIELD = {
  slug: "verdict",
  label: "Verdict",
  fieldType: "REVIEWER_VERDICT" as CodingFieldType,
  required: true,
  orderIndex: 0,
...
const RISK_FIELD = {
  slug: "risk",
  label: "Risk level",
  fieldType: "RISK_LEVEL" as CodingFieldType,
  required: true,
  orderIndex: 1,
};
const CONFIDENCE_FIELD = {
  slug: "confidence",
  label: "Confidence",
  fieldType: "CONFIDENCE_SCORE" as CodingFieldType,
  required: false,
  orderIndex: 2,
...
const NOTES_FIELD = {
  ...
  fieldType: "TEXT" as CodingFieldType,
  required: false,
  orderIndex: 99,
...
export const DEFAULT_SCHEMAS: ReadonlyArray<DefaultSchemaSpec> = [
  {
    slug: "general-evidence",
    label: "General Evidence Review",
    category: "GENERAL_EVIDENCE",
    description:
      "Universal review schema: verdict, risk, confidence, free-form notes.",
  ...
  },
  {
    ...
    description:
      "Insurance Special Investigations Unit review — claim type, indicators, fraud signal.",
    fields: [
      VERDICT_FIELD,
      RISK_FIELD,
      {
  ...
  },
  {
    ...
    description:
      "Legal review schema: relevance, privilege, responsiveness, redaction.",
    fields: [
      VERDICT_FIELD,
      RISK_FIELD,
      {
  ...
  },
  {
    ...
    description:
      "Internal investigation review: severity, scope, evidence integrity, escalation.",
    fields: [
      VERDICT_FIELD,
      RISK_FIELD,
      {
  ...
  },
  {
    ...
    description:
      "Audit + retention review: control, finding, remediation owner.",
    fields: [
      VERDICT_FIELD,
      RISK_FIELD,
      {
  ...
  },
  {
    ...
    description:
      "Source-protection-aware review: source class, on/off record, publication recommendation.",
    fields: [
      VERDICT_FIELD,
      RISK_FIELD,
      {
