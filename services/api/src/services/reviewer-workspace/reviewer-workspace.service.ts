...
export type ProjectReviewerWorkspaceInput = {
  prisma?: PrismaClient;
  teamId: string;
  userId: string;
...
export async function projectReviewerWorkspace(
  input: ProjectReviewerWorkspaceInput,
  ...
  if (!roleResolution.role) return null;
