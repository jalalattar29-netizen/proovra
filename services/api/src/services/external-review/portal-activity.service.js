 ...
 */
import { EXTERNAL_PORTAL_ACTIVITY_CODES, } from "@proovra/shared";
import { prisma as defaultPrisma } from "../../db.js";
export async function emitPortalActivity(input) {
    if (!EXTERNAL_PORTAL_ACTIVITY_CODES.includes(input.code)) {
...
export async function listPortalActivity(input) {
    const prisma = input.prisma ?? defaultPrisma;
