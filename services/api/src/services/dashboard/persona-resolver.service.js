...
function sectionOrderForPersona(persona) {
    switch (persona) {
        case "REVIEWER":
            return [
                "operationalPressure",
...
export function resolveCapabilityMatrix(input) {
    ...
    return {
        ...
        capabilities: {
            reviewerOpsRead,
            reviewerOpsAct: canMutate && (isAdmin || persona === "REVIEWER" || persona === "OPERATOR"),
            governanceRead,
            governanceAct: canMutate && (isAdmin || persona === "GOVERNANCE_OFFICER"),
            bulkActions: canMutate && isAdmin,
            workflowActions: canMutate &&
