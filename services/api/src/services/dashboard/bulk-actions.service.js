...
export async function runBulkAction(input, client = defaultPrisma) {
...
function targetTypeForAction(actionType) {
    switch (actionType) {
...
async function runOneItem(input) {
    ...
    switch (input.actionType) {
        ...
        case "BULK_ESCALATE_WORKFLOWS": {
            const { escalateWorkflow } = await import("../observability/workflow.service.js");
        ...
        case "BULK_RESOLVE_WORKFLOWS": {
            const { resolveWorkflow } = await import("../observability/workflow.service.js");
        ...
        case "BULK_ADD_MITIGATION": {
            ...
            const { addMitigation } = await import("../observability/workflow.service.js");
            await addMitigation({
                workflowId: input.targetId,
                teamId: input.teamId,
        ...
        case "BULK_SCHEDULE_RETRY": {
            ...
            const { scheduleRetry } = await import("../observability/workflow.service.js");
            await scheduleRetry({
                workflowId: input.targetId,
                teamId: input.teamId,
        ...
        case "BULK_SUPPRESS_INCIDENTS": {
            const { suppressIncident } = await import("../observability/incident.service.js");
        ...
        case "BULK_ACKNOWLEDGE_INCIDENTS": {
            const { acknowledgeIncident } = await import("../observability/incident.service.js");
...
export async function getBulkActionRun(input, client = defaultPrisma) {
