...
const DISCLOSURE = readWeb("lib/navigation/navigationDisclosureResolver.ts");
...
const WORKFLOW_EXPOSURE = readWeb("lib/navigation/workflowExposureResolver.ts");
// =============================================================================
...
describe("R2 Part 1 — root primary navigation is bounded to the Phase B canonical set", () => {
    it("CANONICAL_PRIMARY_ROUTE_IDS contains the Phase B canonical primaries", () => {
        ...
        expect(quotedIds, "canonical primary set must contain exactly the Phase B canonical ids").toBe(EXPECTED.length);
    });
});
// =============================================================================
...
describe("R2 Part 2 — operational groups + title vocabulary bounded", () => {
    ...
    it("no new root-group title literals appear in AppSidebarV2.tsx (extracted to canonical module)", () => {
        ...
        expect(matches, `sidebar no longer carries inline title literals — they live in canonicalNavigationGroups.ts. Found: ${matches.join(", ")}`).toEqual([]);
    });
});
// =============================================================================
...
describe("R2 Part 5 — disclosure resolver enforces bounded primary + folds in experience demotion", () => {
    ...
    it("disclosure resolver preserves allToolsItems untouched", () => {
        ...
        expect(DISCLOSURE).toMatch(/recommendedItems:\s*exposure\.recommendedItems/);
    });
});
// =============================================================================
...
describe("R2 Part 10 — invariant pins", () => {
    ...
    it("no second sidebar component was introduced", () => {
        ...
        expect(sidebarFiles, "exactly one canonical sidebar component allowed").toEqual(["AppSidebarV2.tsx"]);
    });
