...
import { parseCertExpiry, getCertExpiryStatus, emitCertExpiryWarningIfNeeded, } from "../src/services/security/saml-cert.service.js";
...
function makeSelfSignedCert(validityDays) {
...
describe("getCertExpiryStatus", () => {
    ...
    it("T06 — returns 'ok' when notAfter is null", () => {
        const status = getCertExpiryStatus(null, NOW);
