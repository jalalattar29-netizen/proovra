/**
 * Types for the shared source-contract helpers (scripts/source-contract).
 * Plain .mjs so every test tree imports one implementation; see its header.
 */
declare module "*/scripts/source-contract/index.mjs" {
