...
const MIGRATION_PATH = fileURLToPath(new URL("../prisma/migrations/20260620300000_team_billing_naming_drift_repair/migration.sql", import.meta.url));
const SCALAR_TYPE_PATTERN = /^(String|Int|BigInt|Boolean|DateTime|Decimal|Float|Bytes|Json|PlanType|TeamBillingStatus|RetentionPolicy|OrganizationVerificationState|WorkspaceCategory)(\?|\[\])?$/;
function readSchema() {
...
function parseModelFields(schema, modelName) {
