...
import { liftIntakeTemplateToWorkflowTemplate, mergeWorkflowTemplates, parseDbWorkflowTemplate, validateWorkflowTemplatePayload, } from "../src/services/workflow-template.service.js";
// -----------------------------------------------------------------------------
// Helpers
// -----------------------------------------------------------------------------
function makeDbRow(overrides = {}) {
    ...
    return {
        ...
        stepsJson: overrides.stepsJson ?? baseSteps,
...
describe("validateWorkflowTemplatePayload", () => {
    ...
    it("rejects a bad slug", () => {
        expect(() => validateWorkflowTemplatePayload({
            slug: "Bad_Slug",
            name: "Invalid",
            planMode: "FLEXIBLE",
            locationRequirement: "optional",
            ...
            rules: [
                {
                    ...
                    then: { action: "deleteEvidence", target: "primary" },
                },
            ],
        })).toThrow();
    });
