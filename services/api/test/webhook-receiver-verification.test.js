...
import { decryptWebhookSecret, issueWebhookSecret, signWebhookPayload, } from "../src/services/integrations/webhooks.service.js";
import { WEBHOOK_HEADER_EVENT, WEBHOOK_HEADER_EVENT_ID, WEBHOOK_HEADER_SIGNATURE, WEBHOOK_HEADER_TIMESTAMP, buildWebhookSignatureBase, } from "@proovra/shared";
...
function receiverVerifySignature(input) {
    ...
    const base = buildWebhookSignatureBase(Number.parseInt(input.timestampHeader, 10), input.body);
