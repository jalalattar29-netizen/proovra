...
describe("E10.2 Test 6 — zero code changes by E10.2", () => {
  ...
  it("the 5 protected core files remain green", () => {
    const PINS = [
      { rel: "src/routes/capture.routes.ts", expected: 18308 },
      { rel: "src/services/evidence-complete.service.ts", expected: 41849 },
      { rel: "src/services/custody-events.service.ts", expected: 4446 },
      { rel: "src/services/timestamp.service.ts", expected: 6033 },
      {
