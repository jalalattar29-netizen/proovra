...
import { buildRecoveryVerifier, computeLookupHash, generateRecoveryBatch, generateRecoveryCode, normalizeRecoveryCode, RECOVERY_CODE_BATCH_SIZE, verifyRecoveryVerifier, } from "../src/services/security/mfa-recovery.js";
// =============================================================================
...
describe("R8.1 recovery — deterministic SHA-256 lookup hash", () => {
    ...
    it("different codes produce different hashes", () => {
        expect(computeLookupHash("ABCDE-FGHJK")).not.toBe(computeLookupHash("ABCDE-FGHJM"));
    });
