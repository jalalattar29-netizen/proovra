...
const ANNOTATION_SVC = readSource("../../../services/api/src/services/reviewer-workspace/annotation-workspace.service.ts");
const BULK_SVC = readSource("../../../services/api/src/services/reviewer-workspace/bulk-operations.service.ts");
const ROUTES = readSource("../../../services/api/src/routes/reviewer-workspace.routes.ts");
const IMG_VIEW = readSource("../../../apps/web/components/reviewer-workspace/viewers/ImageViewer.tsx");
const PDF_VIEW = readSource("../../../apps/web/components/reviewer-workspace/viewers/PdfViewer.tsx");
const VID_VIEW = readSource("../../../apps/web/components/reviewer-workspace/viewers/VideoViewer.tsx");
const AUD_VIEW = readSource("../../../apps/web/components/reviewer-workspace/viewers/AudioViewer.tsx");
const MEDIA_VIEW = readSource("../../../apps/web/components/reviewer-workspace/viewers/MediaViewer.tsx");
const SIDE_PANE = readSource("../../../apps/web/components/reviewer-workspace/SidePaneSwitcher.tsx");
const ANNO_PANEL = readSource("../../../apps/web/components/reviewer-workspace/AnnotationPanel.tsx");
const WS_PAGE = readSource("../../../apps/web/app/(app)/review/workspace/page.tsx");
const QUEUES_PAGE = readSource("../../../apps/web/app/(app)/review/queues/page.tsx");
