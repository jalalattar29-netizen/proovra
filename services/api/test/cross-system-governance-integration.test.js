...
import { PACKAGE_ELIGIBILITY_OUTCOMES, canonicalCanEnterPendingDestruction, canonicalEvaluateExportEligibility, canonicalEvaluatePackageEligibility, exportEligibilityLabel, packageEligibilityLabel, } from "@proovra/shared";
...
describe("Phase 28-D — governance-snapshot.service wiring", () => {
    ...
    it("bumps the governance_snapshot_requested_total counter", () => {
        expect(src).toMatch(/bump\("governance_snapshot_requested_total"\)/);
    });
...
describe("Phase 28-D — operational-timeline.service wiring", () => {
    const src = readSource("../src/services/governance-lifecycle/operational-timeline.service.ts");
...
describe("Phase 28-D — privacy invariants", () => {
    const snapshotSrc = readSource("../src/services/governance-lifecycle/governance-snapshot.service.ts");
    const timelineSrc = readSource("../src/services/governance-lifecycle/operational-timeline.service.ts");
