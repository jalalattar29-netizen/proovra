...
import { buildOtpauthUri, computeTotpCode, decodeBase32, encodeBase32, generateTotpSecretBytes, TOTP_ALGORITHM, TOTP_DEFAULT_WINDOW, TOTP_DIGITS, TOTP_PERIOD_SECONDS, timeStep, verifyTotpCode, } from "../src/services/security/mfa-totp.js";
// =============================================================================
...
describe("R8.1 TOTP — RFC 4648 Base32 round-trip", () => {
    ...
    it("decoder tolerates case + whitespace + padding", () => {
        expect(decodeBase32("mzxw 6ytb oi==")).toEqual(Buffer.from("foobar", "utf8"));
    });
    it("decoder rejects invalid characters", () => {
        expect(() => decodeBase32("MZXW@YTBOI")).toThrowError(/invalid_base32_character/);
    });
});
// =============================================================================
