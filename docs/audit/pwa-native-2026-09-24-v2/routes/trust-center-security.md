# Route register — `/trust-center/security`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/(app)/trust-center/security/page.tsx` | `apps/mobile/app/(stack)/trust-center.tsx` |
| Files in recursive tree | 152 | 144 |
| Max import depth | 8 | 9 |
| **Unresolved imports** | **0** | **0** |
| JSX elements | 209 | 168 |
...
| | PWA | Native |
|---|---:|---:|
| Style properties resolved to literals | 69 | 231 |
...
- `COPY_OR_COMPOSITION_DIFF`: **27** — needs a per-element read.
