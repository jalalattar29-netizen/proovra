# Route register — `/auth/callback/ui`
...
| | PWA | Native |
|---|---:|---:|
| Style properties resolved to literals | 188 | 251 |
| Distinct colours actually used by this route's elements | **21** | **19** |
| — shared between the two | 1 | 1 |
| — **PWA-only (no native counterpart value)** | **20** | — |
| Classes with no matching CSS rule (UNRESOLVED) | 102 (44 distinct) | — |
...
- `COPY_OR_COMPOSITION_DIFF`: **10** — needs a per-element read.
- Web classes with no CSS rule: **102**.
