# Route register — `/data-retention`

**Frozen SHA:** `71e148f34410c7c231f8930d1387d8924b10b4e5` · **Disposition:** `ALIAS_REDIRECT` → `/legal/data-retention`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/data-retention/page.tsx` | `apps/mobile/app/(stack)/legal/[slug].tsx` |
