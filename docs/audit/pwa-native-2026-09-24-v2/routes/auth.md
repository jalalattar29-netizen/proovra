...
**Frozen SHA:** `71e148f34410c7c231f8930d1387d8924b10b4e5` · **Disposition:** `ALIAS_REDIRECT` → `/login`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/auth/page.tsx` | `apps/mobile/app/(stack)/auth.tsx` |
...
| | PWA | Native |
|---|---:|---:|
| Style properties resolved to literals | 0 | 251 |
...
| | PWA | Native |
|---|---:|---:|
| Conditional branches (ternary / && / .map) | 0 | 1059 |
