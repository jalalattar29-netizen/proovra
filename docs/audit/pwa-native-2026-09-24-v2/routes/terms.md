...
**Frozen SHA:** `71e148f34410c7c231f8930d1387d8924b10b4e5` · **Disposition:** `ALIAS_REDIRECT` → `/legal/terms`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/terms/page.tsx` | `apps/mobile/app/(stack)/legal/[slug].tsx` |
