...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/portal/[token]/page.tsx` | `apps/mobile/app/(stack)/portal/[token].tsx` |
| Files in recursive tree | 123 | 139 |
...
| Extra in native | 20 |
| Web elements carrying no literal label | 70 |
...
| | PWA | Native |
|---|---:|---:|
| Conditional branches (ternary / && / .map) | 989 | 1038 |
