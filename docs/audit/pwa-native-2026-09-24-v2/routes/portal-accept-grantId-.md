# Route register — `/portal/accept/[grantId]`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/portal/accept/[grantId]/page.tsx` | `apps/mobile/app/(stack)/portal/accept/[grantId].tsx` |
| Files in recursive tree | 122 | 138 |
...
| | PWA | Native |
|---|---:|---:|
| Conditional branches (ternary / && / .map) | 983 | 1020 |
