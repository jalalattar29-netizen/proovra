# Route register — `/trust-center`

**Frozen SHA:** `71e148f34410c7c231f8930d1387d8924b10b4e5` · **Disposition:** `ALIAS_REDIRECT` → `/trust`
...
| | PWA | Native |
|---|---|---|
| Entry | `apps/web/app/(app)/trust-center/page.tsx` | `apps/mobile/app/(stack)/trust-center.tsx` |
| Files in recursive tree | 1 | 144 |
...
| | PWA | Native |
|---|---:|---:|
| Conditional branches (ternary / && / .map) | 0 | 1072 |
