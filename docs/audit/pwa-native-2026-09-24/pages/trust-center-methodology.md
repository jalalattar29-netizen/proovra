...
**PWA entry:** `apps/web/app/(app)/trust-center/methodology/page.tsx`
...
| Elements | 187 | 77 |
| Interactive elements | 15 | 11 |
| Conditionally-rendered elements | 79 | 39 |
...
|---:|---|---:|---|
| 0 | `apps/web/app/(app)/trust-center/methodology/page.tsx` | 7 | `(entry)` |
...
### C.2 MISSING in Native (9)

| Role | Label | PWA source |
|---|---|---|
| LINK | Evidence Verification Methodology (legal) | `apps/web/app/(app)/trust-center/methodology/page.tsx:33` |
| LINK | Read full legal methodology → | `apps/web/app/(app)/trust-center/methodology/page.tsx:42` |
...
### D.2 PWA SOURCE-UNRESOLVED (88)

- `border` at `apps/web/app/(app)/trust-center/methodology/page.tsx:26` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `border-[#DDE6F2]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:26` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `bg-white/80` at `apps/web/app/(app)/trust-center/methodology/page.tsx:26` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[12.5px]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:26` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[#475569]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:26` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[#0F172A]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:30` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[#2563EB]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:33` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `underline` at `apps/web/app/(app)/trust-center/methodology/page.tsx:33` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `underline-offset-4` at `apps/web/app/(app)/trust-center/methodology/page.tsx:33` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `hover:text-[#1E40AF]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:33` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `ml-auto` at `apps/web/app/(app)/trust-center/methodology/page.tsx:42` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `bg-white` at `apps/web/app/(app)/trust-center/methodology/page.tsx:42` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[11.5px]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:42` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `no-underline` at `apps/web/app/(app)/trust-center/methodology/page.tsx:42` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `hover:border-[#94A3B8]` at `apps/web/app/(app)/trust-center/methodology/page.tsx:42` — no CSS rule in apps/web and not a recognised stock Tailwind utility
