...
| Elements | 180 | 67 |
| Interactive elements | 41 | 16 |
| Conditionally-rendered elements | 74 | 17 |
| Style rules resolved | 57 (222 props) | 78 (92 props) |
...
|---|---|---|---|
| INPUT | Email | `apps/web/app/login/page.tsx:847` | `apps/mobile/app/(stack)/auth.tsx:72` |
| INPUT | Password | `apps/web/app/login/page.tsx:892` | `apps/mobile/app/(stack)/auth.tsx:82` |
| BUTTON | Forgot password? | `apps/web/app/login/page.tsx:935` | `apps/mobile/app/(stack)/auth.tsx:106` |
...
| BUTTON | Back to sign in | `apps/web/components/marketing/ForgotPasswordModal.tsx:227` |
...
| BUTTON | Send reset link | `apps/web/components/marketing/ForgotPasswordModal.tsx:331` |
| BUTTON | Cancel | `apps/web/components/marketing/ForgotPasswordModal.tsx:349` |
| LINK | Back to sign in | `apps/web/components/marketing/ForgotPasswordModal.tsx:366` |
