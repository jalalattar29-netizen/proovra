...
**PWA entry:** `apps/web/app/(app)/operations/quotas/page.tsx`
**Native entry:** `apps/mobile/app/(stack)/operations/quotas.tsx`

| | PWA | Native |
|---|---:|---:|
| Files in rendered tree | 10 | 2 |
| Elements | 207 | 69 |
| Interactive elements | 15 | 9 |
| Conditionally-rendered elements | 88 | 32 |
| Style rules resolved | 38 (117 props) | 65 (72 props) |

## A. PWA component tree (rendered, recursive)

| Depth | File | Elements | Rendered via |
|---:|---|---:|---|
| 0 | `apps/web/app/(app)/operations/quotas/page.tsx` | 79 | `(entry)` |
...
| 1 | `apps/web/components/ui-legacy.tsx` | 27 | `Card,Skeleton` |
...
| Depth | File | Elements | Rendered via |
|---:|---|---:|---|
| 0 | `apps/mobile/app/(stack)/operations/quotas.tsx` | 27 | `(entry)` |
| 1 | `apps/mobile/src/ui/index.tsx` | 42 | `ProovraText,ProovraScreen,ProovraPageHeader,ProovraButton,ProovraPageSection,ProovraLoadingState,ProovraErrorState,ProovraEmpty,ProovraCard,ProovraKpiGrid,ProovraBadge` |
...
|---|---|---|
| BUTTON | Back | `apps/mobile/app/(stack)/operations/quotas.tsx:138` |
| STATE_LOADING | Loading allowances | `apps/mobile/app/(stack)/operations/quotas.tsx:143` |
| STATE_EMPTY | No allowances are published for this account. | `apps/mobile/app/(stack)/operations/quotas.tsx:148` |
| STATE_LOADING | Loading usage | `apps/mobile/app/(stack)/operations/quotas.tsx:162` |
| STATE_EMPTY | No usage has been recorded. | `apps/mobile/app/(stack)/operations/quotas.tsx:169` |
| BADGE | `Total $${usage.data.totalCost.toFixed(2)}` | `apps/mobile/app/(stack)/operations/quotas.tsx:189` |
...
**Stock Tailwind utilities used (11).** `apps/web/tailwind.config.ts` declares `theme: { extend: {} }`, so these carry DEFAULT Tailwind values and are not connected to the PROOVRA token set:
...
### D.2 PWA SOURCE-UNRESOLVED (44)

- `dashboard-quotas-bar-row` at `apps/web/app/(app)/operations/quotas/page.tsx:166` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-bar-top` at `apps/web/app/(app)/operations/quotas/page.tsx:167` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-bar-label` at `apps/web/app/(app)/operations/quotas/page.tsx:168` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-bar-meta` at `apps/web/app/(app)/operations/quotas/page.tsx:169` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-bar-percent` at `apps/web/app/(app)/operations/quotas/page.tsx:194` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-page` at `apps/web/app/(app)/operations/quotas/page.tsx:335` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `border` at `apps/web/app/(app)/operations/quotas/page.tsx:337` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `bg-transparent` at `apps/web/app/(app)/operations/quotas/page.tsx:337` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `shadow-none` at `apps/web/app/(app)/operations/quotas/page.tsx:337` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `z-10` at `apps/web/app/(app)/operations/quotas/page.tsx:341` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-grid` at `apps/web/app/(app)/operations/quotas/page.tsx:348` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `inset-0` at `apps/web/app/(app)/operations/quotas/page.tsx:355` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `object-cover` at `apps/web/app/(app)/operations/quotas/page.tsx:356` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `object-center` at `apps/web/app/(app)/operations/quotas/page.tsx:356` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `scale-[1.12]` at `apps/web/app/(app)/operations/quotas/page.tsx:356` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `bg-[linear-gradient(180deg,rgba(8,20,24,0.82)_0%,rgba(7,18,22,0.88)_100%)]` at `apps/web/app/(app)/operations/quotas/page.tsx:362` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-metric-label` at `apps/web/app/(app)/operations/quotas/page.tsx:364` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-metric-value-lg` at `apps/web/app/(app)/operations/quotas/page.tsx:367` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-metric-sub` at `apps/web/app/(app)/operations/quotas/page.tsx:373` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-metric-value-md` at `apps/web/app/(app)/operations/quotas/page.tsx:400` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `md:p-7` at `apps/web/app/(app)/operations/quotas/page.tsx:427` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-card-title` at `apps/web/app/(app)/operations/quotas/page.tsx:428` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-bar-stack` at `apps/web/app/(app)/operations/quotas/page.tsx:430` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-reset-row` at `apps/web/app/(app)/operations/quotas/page.tsx:459` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-grid-wide` at `apps/web/app/(app)/operations/quotas/page.tsx:471` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `dashboard-quotas-soft-grid` at `apps/web/app/(app)/operations/quotas/page.tsx:488` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `max-w-[760px]` at `apps/web/components/dashboard/DashboardShell.tsx:32` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `text-[1.72rem]` at `apps/web/components/dashboard/DashboardShell.tsx:32` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `leading-[1.02]` at `apps/web/components/dashboard/DashboardShell.tsx:32` — no CSS rule in apps/web and not a recognised stock Tailwind utility
- `tracking-[-0.045em]` at `apps/web/components/dashboard/DashboardShell.tsx:32` — no CSS rule in apps/web and not a recognised stock Tailwind utility

### D.3 Native StyleSheet rules resolved (65 rules, 72 properties)
...
| PWA style items SOURCE-UNRESOLVED | 44 |
| Native style properties resolved | 72 |
| PWA interactive elements | 15 |
| Native interactive elements | 9 |
| PWA conditional branches | 88 |
| Native conditional branches | 32 |
