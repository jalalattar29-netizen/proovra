...
- **Topbar reads canonical:** `AppTopbarV2.tsx:113` consumes `envelope.activeSpace` directly. If type is `PERSONAL`, renders "Personal Space"; otherwise renders `activeSpace.displayName`.
