...
|---|---|---|---|---|
| `apps/web/app/(app)/admin/identity/ui-tokens.ts` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
| `the admin TOKENS.* colour alias map` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
| `apps/web/app/(app)/reviewer-ops/ui-tokens.ts` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
| `the three raw-hex badge palettes that came with it` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
| `--text-muted and --text-strong` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
...
| `admin-v2 files` | `apps/web (app, components, lib)` | 894 | 0 | gone, zero consumers |
