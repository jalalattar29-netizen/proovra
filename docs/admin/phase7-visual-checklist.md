...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin` | 3.7 | 19 | 9 | 0 | no in-page tabs (secondary nav is links) | 1 | 458 KB | 382 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/billing` | 3.7 | 26 | 4 | 5 | no in-page tabs (secondary nav is links) | 1 | 474 KB | 355 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/contact-sales` | 1 | 3 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 162 KB | 69 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/customers/:id` | 3.3 | 11 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 397 KB | 344 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/demo-requests` | 1.3 | 6 | 4 | 0 | no in-page tabs (secondary nav is links) | 1 | 205 KB | 136 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/provisioning` | 2 | 6 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 292 KB | 208 KB | 7w+z200, no overflow | rtl, no overflow | ALREADY_COMPLIANT |
| `/admin/users` | 1.6 | 5 | 0 | 2 | no in-page tabs (secondary nav is links) | 1 | 251 KB | 136 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/users/:id` | 2.7 | 10 | 1 | 2 | no in-page tabs (secondary nav is links) | 1 | 309 KB | 210 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/workspaces` | 1.2 | 2 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 225 KB | 103 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/workspaces/:id` | 2 | 11 | 3 | 1 | no in-page tabs (secondary nav is links) | 1 | 266 KB | 190 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/evidence-ops` | 3.2 | 29 | 4 | 0 | no in-page tabs (secondary nav is links) | 1 | 451 KB | 417 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/platform/media-graph` | 2.1 | 32 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 288 KB | 213 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/recovery` | 1.4 | 4 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 197 KB | 111 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/signers` | 1.2 | 6 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 178 KB | 109 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/identity` | 3.3 | 22 | 0 | 3 | no in-page tabs (secondary nav is links) | 1 | 553 KB | 419 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/identity/providers` | 1.2 | 5 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 219 KB | 150 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/identity/sessions` | 4.9 | 12 | 0 | 4 | no in-page tabs (secondary nav is links) | 1 | 842 KB | 459 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/identity/timeline` | 1.6 | 2 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 298 KB | 136 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/alerts` | 3 | 0 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 472 KB | 384 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/audit` | 3.8 | 11 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 703 KB | 410 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/security` | 4.3 | 16 | 1 | 4 | no in-page tabs (secondary nav is links) | 1 | 558 KB | 430 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/support-access` | 1.9 | 7 | 0 | 2 | no in-page tabs (secondary nav is links) | 1 | 276 KB | 176 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/timeline` | 2.3 | 1 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 457 KB | 237 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/costs` | 2.1 | 18 | 3 | 3 | no in-page tabs (secondary nav is links) | 1 | 374 KB | 288 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/operations` | 3.8 | 8 | 4 | 2 | no in-page tabs (secondary nav is links) | 1 | 693 KB | 342 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform-health` | 2.5 | 18 | 7 | 0 | no in-page tabs (secondary nav is links) | 1 | 428 KB | 359 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| `/admin/platform/observability` | 3.6 | 14 | 3 | 12 | no in-page tabs (secondary nav is links) | 1 | 401 KB | 324 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/queues` | 2.3 | 3 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 331 KB | 223 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/readiness` | 2.7 | 6 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 372 KB | 289 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/reliability` | 1.5 | 10 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 245 KB | 158 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/search` | 1 | 2 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 145 KB | 66 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/platform/runbooks` | 4.2 | 33 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 623 KB | 605 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/platform/runbooks/:slug` | 3.9 | 0 | 0 | 0 | no in-page tabs (secondary nav is links) | 1 | 620 KB | 547 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
...
| route | screens | cards | 1-val | tables | tabs | H1 | desktop | mobile | responsive | RTL | disposition |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `/admin/adoption` | 2 | 1 | 0 | 1 | no in-page tabs (secondary nav is links) | 1 | 303 KB | 203 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/dashboard` | 3.8 | 36 | 6 | 1 | 3-option window control, verified | 1 | 572 KB | 446 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
| `/admin/executive` | 1.8 | 13 | 8 | 2 | no in-page tabs (secondary nav is links) | 1 | 277 KB | 204 KB | 7w+z200, no overflow | rtl, no overflow | REDESIGNED_AND_VISUALLY_VERIFIED |
